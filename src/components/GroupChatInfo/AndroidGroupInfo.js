...
const AndroidGroupInfo = ({ selectedChats }) => {
  ...
  return (
    <View style={styles.whatsappGrpContainer}>
      ...
      <View style={styles.columnContainer}>
        ...
        <View style={styles.textBodyContainer}>
          ...
          <Typography
            text={`Group · ${selectedChats.length} members`}
            size={14}
            marginBottom={14}
          />
        </View>
      ...
      <View style={styles.rowContainer}>
        ...
        <TouchableOpacity style={styles.features} onPress={() => showAlert()}>
          <View style={styles.columnContainer}>
            ...
            />
            <Typography
              text={t("groupInfoScreen.rowHeader.add")}
              color={colors.white}
              size={11}
            />
          </View>
      ...
      <TouchableOpacity onPress={() => showAlert()}>
        <View style={styles.descriptionContainer}>
          ...
          />
          <Typography
            text={`${t("groupInfoScreen.welcomeHeader.title")}, ${t(
              "groupInfoScreen.welcomeHeader.date"
            )}`}
            color={colors.white}
            size={9}
            textAlign={textAlign}
        ...
        <TouchableOpacity onPress={() => showAlert()}>
          <View style={[styles.rowContainer, { flexDirection: rowDirection }]}>
            ...
            >
              ...
              />
              <Typography
                text={t("groupInfoScreen.mediaHeader.mediaVisibility")}
                color={colors.white}
                size={14}
                textAlign={textAlign}
              />
      ...
      <View style={styles.listRowHeaderContainer}>
        <Typography
        ...
        <TouchableOpacity onPress={() => showAlert()}>
          ...
          >
            <Ionicons size={14} name="search" color={colors.white} />
          </View>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.groupFeaturesContainer}>
        <TouchableOpacity onPress={() => showAlert()}>
          ...
          >
            ...
            />
            <Typography
              text={t("groupInfoScreen.shareContactAndFav.addFav")}
              size={15}
              color={colors.white}
              textAlign={textAlign}
            />
        ...
        <TouchableOpacity onPress={() => showAlert()}>
          ...
          >
            ...
            <Typography
              text={`${t(
                "groupInfoScreen.blockReportContainer.block"
              )} Catalin`}
              size={15}
              color={colors.white}
              textAlign={textAlign}
        ...
        <TouchableOpacity onPress={() => showAlert()}>
          ...
          >
            ...
            <Typography
              text={`${t(
                "groupInfoScreen.blockReportContainer.report"
              )} Catalin`}
              size={14}
              color={colors.white}
              textAlign={textAlign}
...
export default AndroidGroupInfo;
